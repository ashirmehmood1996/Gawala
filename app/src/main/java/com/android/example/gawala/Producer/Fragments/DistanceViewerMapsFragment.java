...
public class DistanceViewerMapsFragment extends DialogFragment implements OnMapReadyCallback {
    ...
    private static final String REQUEST_MODEL = "param1";
...
//    private CallBack mListener;
    ...
    public static DistanceViewerMapsFragment newInstance(RequestModel requestModel) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mRequestModel = (RequestModel) getArguments().getSerializable(REQUEST_MODEL);
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng clientLatlng = new LatLng(Double.parseDouble(mRequestModel.getLat())
                , Double.parseDouble(mRequestModel.getLng()));
        mMap.addMarker(new MarkerOptions().position(clientLatlng).title("Client"));
